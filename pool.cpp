...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status = DocumentStatus::ACTUAL) const {            
        ...
        sort(matched_documents_with_status.begin(), matched_documents_with_status.end(),
             [](const Document& lhs, const Document& rhs) {
                 return lhs.relevance > rhs.relevance;
             });
        if (matched_documents_with_status.size() > MAX_RESULT_DOCUMENT_COUNT) {
            matched_documents_with_status.resize(MAX_RESULT_DOCUMENT_COUNT);
        }
        return matched_documents_with_status;
    }
...
private:
    ...
    map<int, DocumentStatus> id_status_;
